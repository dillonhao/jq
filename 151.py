...
def before_trading_start(context):
    ...
    for items in g.stock_nday_out:
        items['daytolive']=items['daytolive']-1
...
def exit_fixdays(context,ndays=5):
    for value in context.portfolio.positions:
        if g.stock_nday_out[value]<1:
            g.stock_nday_out.pop(value)
    #print(value)
